...
public class NeuralNet {
    ...
    // outputs should be squared, then scaled so they all add up to 1
    ...
    public void calculateLearningDeltas() {

        // Traverse backwards through the layers.

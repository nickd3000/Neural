...
public class FormulaTest {
    ...
    public static void testFormula() {
        BasicDisplay display = new BasicDisplayAwt(1280, 1024);
        DrawingContext dc = display.getDrawingContext();
        ...
        NN2Renderer nn2renderer = new NN2Renderer(net, display, 330, 20, 800, 640);
...
//                    }
    ...
    public static void drawGraphPoint(DrawingContext dc, int x, int y, Color c) {
        dc.setDrawColor(c);
        dc.drawRect(x, y,  1,  1);
    }
